class Main extends Phaser.Scene {
    ...
    preload() {
      this.load.spritesheet("plane", "assets/pixil-frame-0.png", {
        frameWidth: 98,
        frameHeight: 83,
      });
      this.load.image("pipe", "assets/png-transparent-scary-zombies-zombie-scary-halloween-thumbnail.png");
    ...
    addRowOfPipes() {
      ...
      for (var i = 0; i < 8; i++) {
        if (!(i >= hole && i <= hole + 2)) this.addOnePipe(4, i * 60 + 10);
      }
    }
    hitPipe() {
